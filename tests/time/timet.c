...
int main(int argc, char* argv[]) {
	...
	if (mysql_query(conn, "SELECT * FROM Channels  INNER JOIN Schedules USING(scheduleID) INNER JOIN Sensors USING(sensorID) INNER JOIN Transitions USING(scheduleID) WHERE enabled = 'yes'"))
