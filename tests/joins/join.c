...
int main(int argc, char* argv[]) {
	...
	if (mysql_query(conn, "SELECT * FROM Channels INNER JOIN Transitions ON P1(T1,Transitions INNER JOIN Schedules ON P2(Transitions,Schedules) WHERE P(T1,Transitions,Schedules)"))
