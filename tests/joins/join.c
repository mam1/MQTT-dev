...
int main(int argc, char* argv[])
{
	...
	if (mysql_query(conn, "SELECT Channels.*, Transitions.*, Schedules.* FROM Channels OUTER JOIN Transitions USING(scheduleID) OUTER JOIN Schedules USING(scheduleID)")) show_mysql_error(conn);
