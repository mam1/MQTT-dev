...
int main(int argc, char* argv[])
{
	...
	if (mysql_query(conn, "SELECT Channels.*, Transitions.*, Schedules.* FROM Channels JOIN Transitions USING(scheduleID) INNDER JOIN Schedules USING(scheduleID)")) show_mysql_error(conn);
