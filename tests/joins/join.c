...
int main(int argc, char* argv[])
{
	...
	if (mysql_query(conn, "SELECT Channels.*, Transitions.*, Schedules.* FROM Channels CROSS JOIN Transitions USING(scheduleID) CROSS JOIN Schedules USING(scheduleID)")) show_mysql_error(conn);
